...
// existing Hono app (createApp).
//
// The fetch handler must wire up the per-request env + DB connection string
// into the module-level slots that getEnv() / getSql() read from. Without
// this step every getEnv() call would throw.
